...
const Signup = () => {
  ...
  return (
    <>
      <SEO 
        title="Sign Up for UniDatez - Join the University Dating Community"
        description="Create your UniDatez account today and join the exclusive dating platform for university students. Connect with like-minded individuals, find your perfect match, and start your dating journey."
        type="website"
      />
      <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <img
          ...
          alt="UniDatez mobile signup background"
          className="absolute inset-0 w-full h-full object-cover sm:hidden"
        />
        <img
          src="/native_login_bg.jpg"
          alt="UniDatez desktop signup background"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                aria-label="Enter your university email"
              />
            </div>
            <div>
              <label
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full px-3 py-2 bg-white border border-pink-300 rounded-md text-sm shadow-sm
                           focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500"
                aria-label="Select your gender preference"
              >
